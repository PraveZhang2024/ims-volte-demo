...
def main():
    ...
    os.system('bash -lc \'source /root/venv/bin/activate && cd /root/ims-volte-demo && python3 main.py --config config/demo.yaml --mode send-sms  --log-level DEBUG --pcscf-ip  {}  --pcscf-port 5060 --imsi {} --impi {} --impu "{}"  --realm {} --k {} --opc {} --smsc {} --target-msisdn "{}" --content {}\''.format(
        f_data['ims_ip'],
        f_data['imsi'],
